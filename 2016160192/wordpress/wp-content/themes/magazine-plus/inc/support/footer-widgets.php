 ...
 * @since 1.0.0
 */
class Magazine_Plus_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'magazine_plus';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'magazine-plus' ), $i ),
...
// Initialize.
$magazine_plus_footer_widgets = new Magazine_Plus_Footer_Widgets();
